...
SRC_DIR="$SCRIPT_DIR/build_debug/CMakeFiles/"
...
lcov -r "${COV_DIR}/coverage.info" "/usr/include/*" "*Qt*.framework*" "*.h" "*/tests/*" "*Xcode.app*" "*.moc" "*moc_*.cpp" "*/test/*" "*/build*/*" -o "${COV_DIR}/coverage-filtered.info"
